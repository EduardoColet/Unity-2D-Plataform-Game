...
public class PlayerController : MonoBehaviour {
    ...
    private AudioSource soundPaused;
    ...
    void Start() {
        ...
        soundAttack = audioSources[0]; 
        soundDeath = audioSources[1];
        soundJump = audioSources[2];
        soundPaused = audioSources[3];
        initialLife = life;
        ChooseDifficulty.selectedDifficulty = ChooseDifficulty.GetSavedDifficulty();
    }
    void Update() {
